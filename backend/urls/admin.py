...
Only registers admin classes when not in mock mode
"""

from django.conf import settings

# Only register admin classes if not in mock mode
if not getattr(settings, 'USE_MOCK', False):
    ...
    # Mock mode - no admin registration
    print("🎭 Mock mode: Admin interface disabled")